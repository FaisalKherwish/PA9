...
bool Game::mainMenu()
{
	...
	sf::Font font("C:\\Users\\ThemN\\OneDrive\\Desktop\\Project\\Sources\\Japers-DK3W.ttf"); // load font
...
void Game::drawBackground(sf::RenderWindow& window, const int state) // loads background textures onto a square
{
	sf::RectangleShape background(sf::Vector2f(1080, 1080));
	sf::Texture backgroundTexture;

	switch (state) // 1- main menu, 2 - game, 3 - game over screen
	{
	case 1: backgroundTexture.loadFromFile("C:\\Users\\ThemN\\OneDrive\\Desktop\\Project\\Sources\\Assets\\Backgrounds\\TitleScreenBG.png");
		background.setTexture(&backgroundTexture);
		break;
	case 2: backgroundTexture.loadFromFile("C:\\Users\\ThemN\\OneDrive\\Desktop\\Project\\Sources\\Assets\\Backgrounds\\GameBG.png");
		background.setTexture(&backgroundTexture);
		break;
	case 3: backgroundTexture.loadFromFile("C:\\Users\\ThemN\\OneDrive\\Desktop\\Project\\Sources\\Assets\\Backgrounds\\GameOverBG.png");
		background.setTexture(&backgroundTexture);
		break;
	}

	window.draw(background); // drawing
}
